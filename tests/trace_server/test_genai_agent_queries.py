...
def test_conversation_custom_attr_distributions(ch_server):
    """Conversation custom attr distributions are batched by visible conversation."""
    ...
    res = ch_server.agent_conversation_custom_attr_distributions(
        AgentConversationCustomAttrDistributionsReq(
            project_id=project_id,
    ...
    by_key = {(item.conversation_id, item.alias): item for item in res.distributions}

    score_a = by_key[conv_a, "custom_float_score_distribution"]
    ...
    env_a = by_key[conv_a, "custom_string_env_distribution"]
    ...
    cached_a = by_key[conv_a, "custom_bool_cached_distribution"]
    ...
    score_b = by_key[conv_b, "custom_float_score_distribution"]
